...
import { KeyRound, Mail, AlertCircle, Loader2, ArrowLeft, CheckCircle } from 'lucide-react';
      ...
      {success && (
        ...
        >
          ...
          <div>
            ...
            <p className="mt-1">Please check your inbox and follow the instructions to reset your password.</p>
          </div>
        </motion.div>
      )}
